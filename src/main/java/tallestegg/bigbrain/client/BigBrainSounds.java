...
public class BigBrainSounds {
    ...
    public static final RegistryObject<SoundEvent> CRITICAL_ACTIVATE = SOUNDS.register("entity.criticalcharge.activate", () -> new SoundEvent(new ResourceLocation(BigBrain.MODID, "entity.criticalcharge.activate")));
    public static final RegistryObject<SoundEvent> CRITICAL_DEACTIVATE = SOUNDS.register("entity.criticalcharge.deactivate", () -> new SoundEvent(new ResourceLocation(BigBrain.MODID, "entity.criticalcharge.deactivate")));
}
